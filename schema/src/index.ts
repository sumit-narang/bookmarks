...
export { migration0004EntityOperationIds } from './migrations/0004_entity_operation_ids';
...
import { migration0004EntityOperationIds } from './migrations/0004_entity_operation_ids';

export const schemaMigrations = [
  migration0001Initial,
  migration0002SyncStateEntityType,
  migration0003AuthSessions,
  migration0004EntityOperationIds,
];
